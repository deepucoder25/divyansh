...
<section class="home-page-slider">
  ...
  <div class="slider-desktop-wrap d-none d-lg-block">
    <div class="container position-relative">
      ...
      <!-- Breadcrumb row at the top -->
      <div class="row pt-3">
        <div class="col-12">
          <nav class="premium-breadcrumb">
            <ul class="p-bc-list">
              <li class="p-bc-item home-icon">
      ...
      <div class="row align-items-center justify-content-between min-vh-slider">
        ...
        <div class="col-lg-7 col-xl-6 text-start hero-text-col pt-4 pb-5">
          ...
          <div class="trusted-badge mb-3">
            ...
            <span class="badge-text">Trusted in <?= $city ?></span>
          </div>

          <!-- Main Heading -->
          <h1 class="hero-title mb-3">
            Best Packers and Movers in<br>
            <span class="accent-text"><?= $city ?></span>
          </h1>
