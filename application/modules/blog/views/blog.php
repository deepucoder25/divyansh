    ...
    <div class="container">
        ...
        <div class="bc-text-area">
            ...
            <div class="bc-sub-row">
                <h1 class="bc-subtitle">Our Blog</h1>
        ...
        <div class="bc-ribbon-wrap">
            <div class="bc-ribbon">
                ...
                <div class="bc-links">
                    ...
                    <span class="bc-current-page">Our Blog</span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden blog-card blog-transition-hover">
                            <div class="position-relative">
                                <a href="<?= $link ?>">
                                    <img loading="lazy" src="<?= $img ?>" class="card-img-top blog-card-img" alt="<?= htmlspecialchars($b->title) ?> - Shifting blog by <?= $company3 ?>">
                                </a>
